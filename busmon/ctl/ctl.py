...
# Override moksha config with busmon config
...
def _in_srcdir(func, *args, **kwargs):
    with utils.DirectoryContext(ctl_config['busmon-src-dir']):
        return func(*args, **kwargs)
...
def _with_moksha_faked(func, *args, **kwargs):
    ...
    moksha_ctl.ctl_config['moksha-src-dir'] = ctl_config['busmon-src-dir']
    ...
    # Go on with our busmon business
...
def bootstrap():
    ...
    print "Really, run './busmon-ctl.py rebuild' to continue."
    return True
